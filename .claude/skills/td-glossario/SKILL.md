...
| "lo zaino" | quanto porta addosso un bracciante. Quando e' pieno smette e va a scaricare |
| "dove scarica" | la cassa che hai assegnato a quel bracciante. Si vede come filo tratteggiato |
| "il magazzino" | il totale in tutte le casse. E' solo un'informazione: nessuno puo' prendere da li' |
...
| "i nastri", "i trasporti" | quello che sposta la roba da solo fra le casse. **E' il momento in cui la catena gira senza di te** |
...
- **"non capisco perche' non lavora nessuno"** → o non ci sono braccianti di quel mestiere, o hanno lo zaino pieno e nessuna cassa con spazio, o l'anello non si vede
- **"camminano troppo"** → questo e' il gioco che funziona: la distanza deve costare. La risposta e' costruire una cassa piu' vicina, non accorciare le strade
