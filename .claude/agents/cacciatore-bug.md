---
name: cacciatore-bug
description: Diagnostica e corregge comportamenti sbagliati partendo da una descrizione in linguaggio comune. Usalo quando qualcosa non funziona come dovrebbe — una coltura che non cresce, una vicinanza che non si accende, il magazzino che non torna, una casella che non si lascia toccare, il gioco che si blocca — invece di modificare il codice a tentativi.
