...
3b. **COMMITTARE NON BASTA: SI SPINGE SUBITO.** In questa sessione la copia di lavoro è tornata indietro a un commit vecchio **dieci volte**, e una volta si è portata via un lavoro che era committato ma non ancora spinto — perso per sempre. Un commit locale **non esiste**. Ogni `git commit` è seguito immediatamente da `git push`, nello stesso comando; non si accumulano mai due lavori sul ramo locale. Se un intervento è lungo, si spinge a pezzi mentre lo si fa.
   **Vale anche per gli agenti**: un agente di ricerca deve scrivere il suo file dopo le prime 4-5 ricerche e riscriverlo mano a mano. Un agente che raccoglie venti ricerche e poi muore prima di scrivere ha lavorato per niente — è successo due volte, e la volta che il file era già scritto si è salvato tutto.
...
15i. **LA DURATA LA FANNO I PROGETTI, IL RITMO LO FANNO I PREZZI.** Se il gioco è troppo corto, **non si alzano i costi**: mancano cose da volere. Alzare i prezzi senza toccare la produzione allunga il tempo lasciandolo identico a se stesso — il giocatore sa benissimo cosa deve fare, ed è il gioco a trattenerlo. Ha un nome nel settore (*padding*, *Fake Longevity*) e i giocatori lo riconoscono. I modi buoni sono quattro, in ordine: **aggiungere cose da comprare**, **aggiungere verbi**, **alzare i costi insieme a un salto di produzione**, **rendere più profonda una ripetizione che c'è già**. Costano tutti tempo di costruzione; quello cattivo è gratis, ed è per questo che tenta.
15j. **UN MIGLIORAMENTO SOTTO IL 15% NON ESISTE.** Non è "poco": è **invisibile**. Due ricerche indipendenti arrivano alla stessa soglia da strade diverse. Un oggetto che dà meno di così non si ritocca, si toglie o si ripensa — lo Zaino grande misurato ×1,00 non è caro, è invisibile.
